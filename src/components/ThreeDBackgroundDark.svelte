<script>
    ...
    class FloatingObject {
        ...
        constructor(
            ...
            this.speedX =
                Math.random() * (speedX - (speedX - 0.045)) + (speedX - 0.045);
            this.speedY =
                Math.random() * (speedY - (speedY - 0.05)) + (speedY - 0.05);
            this.maxX = maxX;
            this.maxY = Math.random() * (maxY - (maxY - 5)) + (maxY - 5);
            this.spawnX =
                Math.random() * (spawnX - (spawnX - 10)) + (spawnX - 10);
            this.spawnY =
                Math.random() * (spawnY - (spawnY - 20)) + (spawnY - 20);
            this.object = object;
        ...
        animate(timeAdd) {
            ...
            this.object.position.y =
                Math.sin(this.time * this.speedY) * this.maxY;
